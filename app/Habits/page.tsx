...
export default function Page() {
  ...
  const [selectedHabits, setSelectedHabits] = useState<(number | boolean)[]>(
    [],
  );
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative w-[300px] h-[300px] md:w-[340px] md:h-[340px] rounded-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 shadow-2xl overflow-hidden">
            ...
            {/* Selection Badge */}
            {selectedHabits.includes(index as number | boolean) && (
              <motion.div
        ...
        >
          <div className="flex justify-between text-sm text-gray-400 mb-2">
            <span>Progress</span>
            <span>
              {selectedHabits.length}/{habits.length} habits selected
            </span>
          </div>
